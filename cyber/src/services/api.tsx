...
export const alertService = {
  getAlerts: (params) => api.get('/app/v1/cyber/alerts'),
  getAlertById: (id) => api.get(`/app/v1/cyber/alerts/${id}`),
...
export const incidentService = {
  getIncidents: (filters) => api.get('/app/v1/cyber/incidents', filters),
...
export const threatsService = {
  ...
  deleteThreatAsset: (threatId, assetId) =>
    api.delete(`/app/v1/cyber/threat_intelligence/${threatId}/${assetId}`),
  ...
  removeThreatVulnerability: (threadId, vulnerabilityId) =>
      api.delete(`/app/v1/cyber/threat_intelligence/vulnerabilities/${threadId}/${vulnerabilityId}`),
}
