...
class VulnerabilitySchema(Schema):
    vulnerability_id: Optional[int] = Field(None, description="ID of the vulnerability")
    ...
    discovery_date: Optional[datetime] = Field(None, description="Date when the vulnerability was discovered")
